    ...
    public void test_HereAccessTokenProvider_retry() throws IOException, HttpException {
        ...
        try (
                HereAccessTokenProvider hereAccessTokenProvider
                        = HereAccessTokenProvider.builder()
                        .setHttpProvider(mockHttpProvider)
                        .setRetryPolicy(new ExponentialRandomBackoff())
                        .build();
        ) {
            AccessTokenResponse accessTokenResponse = hereAccessTokenProvider.getAccessTokenResponse();
    ...
    public void test_HereAccessTokenProvider_retry_1_times() throws IOException, HttpException {
        ...
        try (
                HereAccessTokenProvider hereAccessTokenProvider
                        = HereAccessTokenProvider.builder()
                        .setHttpProvider(mockHttpProvider)
                        .setRetryPolicy(new ExponentialRandomBackoff(100, 1))
                        .build();
        ) {
            AccessTokenResponse accessTokenResponse = hereAccessTokenProvider.getAccessTokenResponse();
            Mockito.verify(mockHttpProvider, Mockito.times(2)).execute(any(HttpProvider.HttpRequest.class));
        }
    }
